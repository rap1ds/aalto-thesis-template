...
% Kivi on materiaali, joka muodostuu mineraaleista ja luokitellaan mineraalisisältönsä mukaan.
% }
...
\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=\textwidth]{indica_model.pdf}
...
\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=9cm]{ihaa.jpg}
...
\subfigure[Examples of obstruction graphs for the Ferry Problem]{
  \input{obstruction-grouped.tex}
}
\subfigure[Examples of star graphs]{
  \input{general-star-graphs.tex}
}
